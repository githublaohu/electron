...
public class BrokerStartup {
	...
	public static BrokerController createBrokerController(String[] args) {
		String rootPath = BrokerStartup.class.getProtectionDomain().getCodeSource().getLocation().getPath();
		try {
			...
			return new BrokerController(electronConfig, electronConfigList);
		}catch(Exception e) {
