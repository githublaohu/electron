...
public class PostAbilityWrapper extends AbstractChainAbilityWrapper {
	...
	public PostAbilityWrapper(PostAbility postAbility) {
		super(postAbility);
	...
	public ElectronResponse run(ElectronRequest electronRequest, ElectronResponse electronResponse, Invoker invoker) {
		return postAbility.post(electronRequest, electronResponse, invoker);
	}

	@Override
	public String toString() {
		return "PostAbilityWrapper [postAbility=" + postAbility + "]";
	}
