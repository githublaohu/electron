...
@Register(node= {"organizationTypeEnum","organizationName","abilityTypeEnum","arId"},persistence = true)
public interface AbilityRelationRegister extends RegisterServer<AbilityRelation> {
