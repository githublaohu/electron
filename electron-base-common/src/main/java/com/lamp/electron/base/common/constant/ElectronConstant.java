 ...
 */
package com.lamp.electron.base.common.constant;

public class ElectronConstant {

	public static final String ELECTRON_NAME = "electron";
	
	public static final String USER_INFO_KEY_NAME = "USER_INFO";
