...
public class DataInjection {
	...
	private boolean isPrivateHeader = true;

	private List<ResultDataDisposeInfo> resultDataDisposeInfo;

	@Data
	public static class ResultDataDisposeInfo {

		private DataSpot dataSpot;

		private DataSpot operateSpot;

		private DataSpot regionSpot;
