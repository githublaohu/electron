...
<template>
  <div class="page-container demoForm-container">
    ...
    <div class="m-table-mod">
         <d2-crud :columns="columns" :data="data" :options="options"  :pagination="pagination" @row-click="interfaceVisible =!interfaceVisible"
...
<el-drawer title="添加" :visible.sync="addVisible" :direction="direction" :before-close="handleClose">
  <el-form :model="form" ref="form">
    ...
    <el-form-item label="组织说明" prop="oiExplain">
          <el-input type="textarea"  v-model="form.oiExplain" placeholder="请填写组织说明" style="width:62%"/>
    </el-form-item>
        <el-button type="success" @click="addModel" size="small">添加</el-button>
      </el-form>
</el-drawer>

<el-drawer title="接口信息" :visible.sync="interfaceVisible" :direction="direction"  @open="interface.queryModelList">
      <div class="m-table-mod">
         <d2-crud :columns="interface.columns" :data="interface.data" :options="interface.options"  :pagination="interface.pagination"  />
    </div>
</el-drawer>
  </div>
</template>
...
var vueData = {      dialogTitle: "新增",addVisible: false, updateVisible: false, interfaceVisible:false};

vueData.data = []
vueData.pagination = {     currentPage: 1 ,pageSize: 10, total: 0 };
vueData.filter = { oiName : ""};
vueData.form = { oiName : "" , oiEnglishName:"",oiType:"TEAM",oiSuperiorId: 0,oiLabel:"",oiExplain:""}
vueData.update =  { oiName : "" , oiEnglishName:"",oiType:"",oiLabel:"",oiExplain:"",oiCreaterName:"",
                                     oiOwnerName:"",createTime:"",updateTime:""}
vueData.columns = [
  {title:"项目名",key:"oiName"},
  {title:"项目英文名",key:"oiEnglishName"},
  {title:"项目类型",key:"oiType"},
  {title:"项目说明",key:"oiExplain"},
  {title:"创建人名",key:"oiCreaterName"},
  {title:"拥有人名",key:"oiOwnerName"},
...
methods.queryModelList = function(currentPage){
...
methods.paginationCurrentChange = function(currentPage) {
...
methods.interface = {}
methods.interface.pagination = {     currentPage: 1 ,pageSize: 10, total: 0 };
methods.interface.data = {}
methods.interface.columns = {}

methods.interface.queryModelList = function(){

}

methods.interface.paginationCurrentChange = function(currentPage) {
      this.interface.pagination.currentPage = currentPage;
      this.interface.filter.pageNumber = currentPage;
      this.interface.queryModelList();
}
