  ...
  <div class="page-container demoForm-container">
    ...
    <el-form :inline="true" :model="filter" class="filter-form-mod">
      <div class="filter-form-row">
       <el-form-item label-width="100px" label="url：" class="col-filter-item">
          <el-input v-model="filter.url" placeholder="请输入url" clearable size="small"/>
        </el-form-item>
...
vueData.filter = { networkAddress : "",url:""};
vueData.columns = [
  {title:"path",key:"path"},
...
methods.queryModelList = function(){
    exampleApi.queryNodeBaseListByFrom(this.filter,this.pagination).then(res => {
        this.data = res.data;
