...
import com.lamp.electron.client.transmit.Dransmission;

public class DubboDransmission implements Dransmission {

	@Override
	public void dransmission(String key, String data) {
		 RpcContext.getContext().setAttachment(key, data);
	}
